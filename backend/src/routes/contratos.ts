...
export const ContratoPayloadSchema = z.object({
  ...
  arquiteto_cpf: z.string().optional(),
  arquiteto_cnpj: z.string().optional(),
  ...
  area_projeto: z.string().optional(),
  ...
  finalidade_uso: z.string().optional(),
  prazo_documentos: z.string().optional(),
  lista_documentos: z.string().optional(),
  prazo_orcamento_aditivo: z.string().optional(),
  prazo_aviso_rescisao: z.string().optional(),
  cidade_foro: z.string().optional(),
